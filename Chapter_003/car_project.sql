...
select b.body_name
from car_project c right join car_body b on c.body_id = b.body_id
where c.car_project_id is null;

select e.engine_name
from car_project c right join car_engine e on c.engine_id = e.engine_id
where c.car_project_id is null;

select t.transmission_name
from car_project c right join car_transmission t on c.transmission_id = t.transmission_id
where c.car_project_id is null;