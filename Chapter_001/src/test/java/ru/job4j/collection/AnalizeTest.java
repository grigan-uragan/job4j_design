...
public class AnalizeTest {
    ...
    @Test
    public void whenNoAddTwoChangeTwoDelThenZeroTwoTwo() {
        Analize analize = new Analize();
        Analize.User one = new Analize.User(1, "One");
        Analize.User two = new Analize.User(2, "Two");
        Analize.User three = new Analize.User(3, "Three");
        ...
        current.add(fiveChange);
        current.add(fourChange);
        assertThat(analize.diff(previous, current), is(new Analize.Info(0, 2, 2)));
    }

    @Test
    public void whenOneAddNoChangedTwoDelThenOneZeroTwo() {
        Analize analize = new Analize();
        Analize.User one = new Analize.User(1, "One");
        Analize.User two = new Analize.User(2, "Two");
        Analize.User three = new Analize.User(3, "Three");
        ...
        current.add(four);
        current.add(six);
        assertThat(analize.diff(previous, current), is(new Analize.Info(1, 0, 2)));
    }
}